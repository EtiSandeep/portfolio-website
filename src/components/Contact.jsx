        ...
        <section id="contact" className="py-24 relative">
            <div className="max-w-4xl mx-auto px-6">
                <motion.div
                    ...
                    className="p-8 md:p-14 bg-gradient-to-br from-coral via-tangerine to-gold rounded-[2.5rem] overflow-hidden relative shadow-2xl shadow-coral/30"
                >
                    {/* Decor */}
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center relative">
                        ...
                        <div className="space-y-6">
                            <a href={`mailto:${profile.contact.email}`} className="flex items-center gap-4 p-4 rounded-2xl bg-white/15 hover:bg-white/25 backdrop-blur-sm transition-colors group">
                                <div className="w-12 h-12 rounded-full bg-white/25 flex items-center justify-center text-white group-hover:bg-white group-hover:text-coral transition-all">
                                    <Mail size={20} />
                                </div>
                                <div>
                        ...
                        <form className="space-y-4">
                            ...
                            <button className="w-full py-4 bg-white rounded-xl font-bold text-coral hover:bg-cream transition-colors flex items-center justify-center gap-2">
                ...
                <div className="mt-20 text-center border-t border-ink/10 pt-8">
