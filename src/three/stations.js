...
export const STATIONS = [
    ...
    { id: "about", anchor: [6.5, -12, -10], camOffset: [0, 1.0, 10.5], pieceSide: -1 },
    { id: "experience", anchor: [-6.5, -25, -22], camOffset: [0, 0.6, 14.0], pieceSide: 1 },
    { id: "skills", anchor: [5.5, -38, -35], camOffset: [0, 0.5, 15.0], pieceSide: 0, pieceLift: 0.05 },
    { id: "projects", anchor: [-6.0, -51, -48], camOffset: [0, 1.6, 14.5], pieceSide: 1 },
    { id: "contact", anchor: [0, -64, -62], camOffset: [0, 0.6, 14.5], pieceSide: 0 },
];
